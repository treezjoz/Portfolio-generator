          ...
          <div className="col-md">
            <div className="ftco-footer-widget" style={{textAlign:'center'}}>
              ...
              <ul className="ftco-footer-social list-unstyled">
                ...
                <li ><a href={props.resumeData.github} target="_blank" rel="noopener noreferrer"><span className="fa fa-github"></span></a></li>
                <li ><a href={props.resumeData.instagram} target="_blank" rel="noopener noreferrer"><span className="fa fa-instagram"></span></a></li>
              </ul>
            </div>
          </div>
        </div>
